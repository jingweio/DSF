...
class DSF_Bern_R(torch.nn.Module):
    def __init__(self, in_dim, hid_dim, out_dim, args, PE_in_dim, PE_hid_dim, PE_alpha=0.1, K=10):
        super(DSF_Bern_R, self).__init__()
        args.K = K
        ...
        self.prop1 = _prop(args.K, PE_hid_dim, PE_alpha)
...
class _prop(MessagePassing):
    def __init__(self, K, PE_hid_dim, PE_alpha, **kwargs):
